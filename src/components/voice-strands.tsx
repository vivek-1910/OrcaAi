...
export default function Strands({
  ...
  }, [amplitude, dispersion, glass, glassSize, glow, hueShift, intensity, opacity, refraction, saturation, scale, speed, spread, taper, thickness, waviness])

  return <div ref={containerRef} className={`voice-strands-container ${className}`.trim()} style={style} />
}
